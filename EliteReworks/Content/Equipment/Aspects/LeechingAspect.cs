...
namespace EliteReworks.Elites
{
    class LeechingAspect : EliteEquipmentBase<LeechingAspect>
    {
        ...
        public override string EquipmentName => "N\u2019Kuhana\u2019s Concession";//change this later

        public override string TOKEN_IDENTIFIER => "LEECH";

        public override string EquipmentPickupDesc => "Become an aspect of eternity.";
        ...
        private void CreatePulsePrefab()
        {
            ...
            Modules.Content.AddEntityState(typeof(LeechingHealNovaPulse));
