...
namespace EliteReworks.Elites
{
    class VolatileAspect : T1EliteEquipmentBase<VolatileAspect>
    {
        ...
        public override string EquipmentName => "Bava\u2019s Refrain";

        public override string TOKEN_IDENTIFIER => "EXPLOSIVE";

        public override string EquipmentPickupDesc => "Become an aspect of force.";

        public override string EquipmentFullDescription => "All attacks are explosive. Periodically fire a mortar.";
