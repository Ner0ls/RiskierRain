...
namespace EliteReworks.Elites
{
    class SimulatedAspect : EliteEquipmentBase<SimulatedAspect>
    {
        ...
        public override string EquipmentName => "Abyssal gaze"; //temp name

        public override string TOKEN_IDENTIFIER => "SIMULATED";

        public override string EquipmentPickupDesc => "Become an aspect of the simulacrum";

        public override string EquipmentFullDescription => "Some stats up idk, lol";
        ...
        public override float BaseCooldown { get; } = 6f;
