...
namespace EliteReworks.Elites
{
    class FrenziedAspect : T1EliteEquipmentBase<FrenziedAspect>
    {
        ...
        public override string EquipmentName => "Chir\u2019s Tempo"; //momentum, tempo, alacrity, velocity

        public override string EquipmentPickupDesc => "Become an aspect of velocity.";

        public override string TOKEN_IDENTIFIER => "SPEED";

        public override string EliteModifier => "Hallowed";

        public override string EquipmentFullDescription => "Increase movement, attack, and ability recharge speed.";
        ...
        public override float BaseCooldown { get; } = 0f;
