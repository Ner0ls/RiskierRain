...
namespace SurvivorTweaks.Modules
{
    ...
    public static class Config
    {
        ...
        {
            MyConfig = new ConfigFile(Paths.ConfigPath + $"\\{SurvivorTweaksPlugin.guid}.cfg", true); //FortunesPlugin.instance.Config;
            BackupConfig = new ConfigFile(Paths.ConfigPath + $"\\{SurvivorTweaksPlugin.guid}.Backup.cfg", true);
