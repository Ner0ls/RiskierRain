...
namespace SurvivorTweaks.Skills
{
    class PocketWormholeSkill : SkillBase<PocketWormholeSkill>
    {
        ...
        public override Sprite Icon => assetBundle.LoadAsset<Sprite>("Assets/Icons/pocketwormhole.png");// assetBundle.LoadAsset<Sprite>(CommonAssets.iconsPath + "Skill/" + "PocketWormhole" + ".png");
