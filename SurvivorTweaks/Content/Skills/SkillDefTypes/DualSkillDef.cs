...
namespace SurvivorTweaks.Skills.SkillDefTypes
{
    class DualSkillDef : SkillDef
	{
		...
		public override EntityState InstantiateNextState(GenericSkill skillSlot)
		{
			...
			{
				entityState = EntityStateCatalog.InstantiateState(ref this.activationState);
			}
            else
			{
				entityState = EntityStateCatalog.InstantiateState(ref this.alternateActivationState);
			}
