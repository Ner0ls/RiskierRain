...
namespace RiskierRainContent.Skills
{
    class ExplosiveArrowSkill : SkillBase
    {
        ...
        public override void Init(ConfigFile config)
        {
            ...
            Content.AddEntityState(typeof(FireExplosiveArrow));
        }
        ...
        private void CreateProjectile()
        {
            ...
            CommonAssets.projectilePrefabs.Add(regularArrowPrefab);
            CommonAssets.projectilePrefabs.Add(critArrowPrefab);
            CommonAssets.projectilePrefabs.Add(critBombletsPrefab);
        }
    }
}
