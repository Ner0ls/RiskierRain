...
using SurvivorTweaks;
using System.Runtime.CompilerServices;
using SurvivorTweaks.Unlocks;
...
namespace SurvivorTweaks.Skills
{
    public abstract class SkillBase<T> : SkillBase where T : SkillBase<T>
    {
        ...
        public SkillBase()
        {
            if (instance != null) throw new InvalidOperationException(
                $"Singleton class \"{typeof(T).Name}\" inheriting {SurvivorTweaksPlugin.modName} {typeof(SkillBase).Name} was instantiated twice");
            instance = this as T;
        }
    }
    ...
    public abstract class SkillBase : SharedBase
    {
        ...
        public virtual MageElement Element { get; set; } = MageElement.None;
        ...
        public override void Init()
        {
            ...
            if (SurvivorTweaksPlugin.isScepterLoaded && ScepterSkillName != null)
            {
                CreateScepterSkill();
            }
        }
        ...
        {
            ScepterSkillDef = SurvivorTweaksPlugin.CloneSkillDef(SkillDef);
        ...
        public Sprite LoadSpriteFromBundle(string name) { return assetBundle.LoadAsset<Sprite>(SurvivorTweaksPlugin.iconsPath + name + ".png"); }
        ...
        private void CreateSkill()
        {
            ...
            this.SkillDef.canceledFromSprinting =
                !(SurvivorTweaksPlugin.autosprintLoaded || !SkillData.cancelSprintingOnActivation || SkillData.forceSprintingDuringState)
