...
namespace SurvivorTweaks.States.Huntress
{
    class ThrowLaserrang : BaseState
	{
		public static float baseDuration => LaserrangSkill.baseDuration;
		public static float damageCoefficient => LaserrangSkill.damageCoefficient;
		public static float force => LaserrangSkill.force;
		...
		public static float antigravityStrength => LaserrangSkill.antiGravStrength;
